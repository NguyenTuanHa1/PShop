...
<section class="gap">
    <div class="container">
        <a href="/addVoucher" class="btn btn-primary">Thêm voucher</a>
        <table class="table table-bordered">
            ...
            <c:forEach var="voucher" items="${listVoucher}">
                <tr>
                    ...
                    <td>${voucher.value}</td>
                    <td><c:choose>
                        <c:when test="${voucher.typeSale == true}">Percentage</c:when>
                        <c:otherwise>Fixed Amount</c:otherwise>
                    </c:choose></td>
                    <td><c:choose>
                        <c:when test="${voucher.status == true}">Active</c:when>
                        <c:otherwise>Inactive</c:otherwise>
                    </c:choose></td>
                    <td>${voucher.describeVoucher}</td>
                    <td><fmt:formatNumber value="${voucher.maxSale}"  type="number"/> </td>
